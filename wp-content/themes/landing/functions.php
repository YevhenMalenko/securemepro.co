...
if ( ! function_exists( 'landing_setup' ) ) :
	...
	function landing_setup() {
		...
		register_nav_menus( array(
			...
			'headermenu' => esc_html__( 'Header Menu', 'landing' ),
		) );
...
function landing_scripts() {
	...
	wp_enqueue_style( 'landing-styles.min', get_template_directory_uri().'/assets/css/styles.min.css' );

	wp_enqueue_script( 'landing-wow', get_template_directory_uri() . '/assets/js/wow.js', array(), '1.0', true );

	wp_enqueue_script( 'landing-scripts', get_template_directory_uri() . '/assets/js/scripts.js', array(), '1.0', true );
